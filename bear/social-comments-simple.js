(function() {
  ...
  const icons = {
    ...
    webmentions: '<svg class="sr-icon-webmentions" viewBox="0 0 1024 1024" fill="currentColor" width="18" height="18"><path d="M857 216l-230 214h111l-85 368h-2l-120 -368h-144l-121 362h-2l-111 -476h-153l185 700h155l117 -363h2l118 363h153l157 -586h113z"/></svg>'
  };
  ...
  style.textContent = `
    ...
    .simple-reaction-button .icon svg.sr-icon-webmentions {
      transform: translateY(-1px);
    }
