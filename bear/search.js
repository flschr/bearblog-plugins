document.addEventListener('DOMContentLoaded', () => {
  ...
  endHint.style.cssText = 'text-align: center; padding: 2rem 0; color: var(--text-muted, #666); font-family: monospace; display: none;'
  endHint.innerHTML = `<p>ʕ•ᴥ•ʔ bear end</p>`
